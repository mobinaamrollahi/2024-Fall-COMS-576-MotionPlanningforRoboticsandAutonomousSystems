...
def main_rrt(
    ...
    """Problem 1 (Exploring the C-space using RRT) and Problem 2 (Solve the planning problem using RRT)"""
    fig, (ax1, ax2, ax3) = plt.subplots(3, 1)

    # Problem 1a: Neglect obstacles and goal
    ...
    # Problem 1b: Include obstacles, neglect goal
    ...
    # Problem 2: Include obstacles and goal
    title3 = "RRT planning"
    (G3, root3, goal3) = rrt(
        cspace=cspace,
        qI=qI,
...
def main_prm(
    ...
    """Problem 3 (Solve the planning problem using PRM)"""
    fig, ax = plt.subplots()
    title = "PRM planning"
    (G, root, goal) = prm(
        cspace=cspace,
